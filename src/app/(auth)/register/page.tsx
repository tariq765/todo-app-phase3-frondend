    ...
    <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-cyan-50">
      ...
      <div className="relative z-10 sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-3 text-center text-lg text-gray-600">
          Join our community and boost your productivity
        </p>
      </div>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="bg-gradient-to-br from-white to-blue-50/30 backdrop-blur-xl py-10 px-8 shadow-2xl sm:rounded-3xl sm:px-12 transition-all duration-500 hover:shadow-2xl border border-white/50">
          ...
          <form className="space-y-7" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-gray-500">Use at least 6 characters</p>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={loading}
                  className={`block w-full pl-12 pr-4 py-4 border ${password === confirmPassword || confirmPassword === '' ? 'border-gray-200' : 'border-red-300'} rounded-2xl shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-300 placeholder-gray-500 bg-white/80 focus:bg-white ring-1 ${password === confirmPassword || confirmPassword === '' ? 'ring-gray-200/50' : 'ring-red-200/50'} text-base`}
          ...
          <div className="mt-10">
            ...
            <div className="mt-8 text-center">
              <p className="text-base text-gray-600">
                ...
                <Link href="/login" className="font-bold text-indigo-600 hover:text-indigo-500 transition-colors duration-200 hover:underline">
                  Sign in here
                </Link>
              </p>
            </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          <p>By creating an account, you agree to our <span className="font-medium underline hover:no-underline cursor-pointer transition-all">Terms of Service</span> and <span className="font-medium underline hover:no-underline cursor-pointer transition-all">Privacy Policy</span></p>
        </div>
      </div>
    </div>
  );
